...
@section('page-contents')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add Useful links</h1>
        {{-- <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i> Generate Report</a> --}}
    </div>
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <form method="POST" action="{{ route('admin.information-links.update', $link->id) }}" enctype="multipart/form-data">
                @method('PATCH')
                @csrf
                ...
                <div class="form-group">
                    <div class="image-section">
                        <div class="image"> <img src="{{ asset("storage/$link->banner") }}" height="50px">
                        </div>
                    </div>
                </div>
                <div class="form-group">
